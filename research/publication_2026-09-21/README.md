...
6. `figures/build_figures.py` generates SVG and 300-dpi PNG scientific diagrams. `build_publication.py` generates the editable DOCX from the main text, supplemental methods, tables, opportunities and canonical reference registry.
