...
Version 0.2 — September 21, 2026. **Proposed formal procedures with an executed PubMed development search.** Prepared after exploratory searching, selected extraction, hypothesis development, and descriptive CMS analyses. The [execution record](../review_2026-09-21/README.md) distinguishes performed work from pending procedures; the [preceding protocol](../review_2026-09-21/protocol_before_search.md) is preserved. This document does not supersede `REVIEW_SCOPE.md` or retroactively make earlier work prospective. Changes to eligibility require a dated scope amendment.
...
The primary publication will be a systematic review of empirical evidence with a separately documented Medicare policy context. The attached methodological guide is used as secondary workflow background [M-009], while PRISMA, risk-of-bias, and certainty frameworks remain distinct methods sources. The existing original CMS formulary and five-pair RVU analyses will remain exploratory companion analyses unless their inclusion is agreed with the journal and each analysis receives a full independent methods and limitations account. A review's PRISMA flow will not imply that these original analyses were identified as included studies.
...
A health-sciences librarian or information specialist should develop the strategy; another information specialist should independently peer-review it using PRESS [M-005]. Search PubMed (including MEDLINE), Embase, CINAHL, EconLit, and Scopus or Web of Science. PubMed development queries were executed through NCBI E-utilities on September 21, 2026 before PRESS review. Subscription access for other databases has not been confirmed and their searches remain pending. Record each platform/version, full translated strategy, coverage dates, execution timestamp, limits, results and export file. Report unavailable databases and any replacement with its rationale and limitations.

Combine a sensitive Medicare/financing search without a mandatory sex/gender term with sex/gender and indication-specific supplementary searches. Do not require the word 'bias', a cisgender label, an opposite-sex comparator, or a named drug. This avoids excluding sex-specific care and studies with unanticipated results. The working search is in `search_strategy_draft.md`; its executed development version revealed an invalid formulary subject heading (corrected with 60 additional records) and a screening-vocabulary miss. Specialist revision and PRESS review remain necessary before treating the strategy as final. No record was excluded by the priority metadata-export subset.
...
Each amendment must state date, rationale, stage, affected records/outcomes and whether findings were known. Re-screen affected records after eligibility changes. The nine current hypotheses are exploratory; only genuinely new, prospectively fixed analyses can be described as prespecified for the subsequent phase.
...
Prepare PRISMA 2020, PRISMA for Abstracts and PRISMA-S materials, plus applicable equity items [M-001, M-004, M-006]. The attached local PRISMA 2020 checklist is a reporting template; its prefilled page locations are not locations in this project and will be replaced only after the final manuscript and supplement exist. This draft protocol draws on PRISMA-P [M-003]. Complete checklists with manuscript/supplement locations only after procedures and reporting are complete. Reconcile records, reports and studies in the flow diagram, separating database and other-method identification routes. Never substitute the current 38-record selected inventory or raw query-hit counts for final selection counts.
...
Method references M-001–M-009 appear in the [living bibliography](../../outputs/01a0ab2c-c289-74e3-8442-d7966be4cbe8/Medicare_gender_care_bibliography.md). The [readiness crosswalk](PRISMA_readiness_crosswalk.md) links the principal reporting requirements to current gaps and required artifacts.
